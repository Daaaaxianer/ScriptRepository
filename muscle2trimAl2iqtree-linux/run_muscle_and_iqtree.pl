...
####
system("muscle -in $infile -fastaout $infile.fasta -phyiout $infile.phyi");
...
system("iqtree -s $infile.phyi -bb 1000 -bnni -redo -nt AUTO");
...
# ####
system("cp $infile.phyi.treefile $infile.phyi.treefile.nwk");
#####
